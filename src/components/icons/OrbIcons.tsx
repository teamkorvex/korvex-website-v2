...
export function ShieldLockIcon({ className = '', size = 48 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DocumentCheckIcon({ className = '', size = 48 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function EnvelopeIcon({ className = '', size = 48 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FingerprintIcon({ className = '', size = 48 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M12 10a2 2 0 0 1 2 2c0 2.3-2 3-2 5" />
      <path d="M8.5 19.5C8 18 8 16 8 12a4 4 0 0 1 4-4" />
      <path d="M21.17 15.5A9 9 0 0 0 12 6a9 9 0 0 0-7.96 4.88" />
      <path d="M12 18a2 2 0 0 0 2-2c0-1.5-1-2-1-3.5" />
      <path d="M15.5 19.5c.5-1.5.5-2.5.5-4.5a2.5 2.5 0 0 0-2.5-2.5" />
    </svg>
  );
}
...
export function UserIcon({ className = '', size = 48 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ShieldCheckIcon({ className = '', size = 48 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function UserCogIcon({ className = '', size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
